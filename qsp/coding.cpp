...
unsigned char qspCP1251ToKOI8RTable[] = {
    ...
    0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20,
    0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x9A, 0x20, 0x20, 0x20,
    0x20, 0x20, 0x20, 0x20, 0xB3, 0xBF, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20,
    0x9C, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x9E, 0xA3, 0x20, 0x20, 0x20,
    0x20, 0x20, 0x20, 0x20, 0xE1, 0xE2, 0xF7, 0xE7, 0xE4, 0xE5, 0xF6, 0xFA,
...
unsigned char qspCP1251ToUpperTable[] = {
    ...
    0x8C, 0x8D, 0x8E, 0x8F, 0xA0, 0xA1, 0xA1, 0xA3, 0xA4, 0xA5, 0xA6, 0xA7,
...
unsigned char qspCP1251OrderTable[] = {
    0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B,
    0x0C, 0x0D, 0x0E, 0x0F, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17,
    0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F, 0x20, 0x22, 0x23, 0x24,
    ...
    0x79, 0x7A, 0x7B, 0x7C, 0x7D, 0x7E, 0x7F, 0x80, 0x91, 0x92, 0xF2, 0xE0,
    0xF5, 0xF9, 0xF6, 0xF7, 0xFD, 0xFA, 0x98, 0xFB, 0x99, 0x9B, 0x9A, 0x9D,
    0xDF, 0xF0, 0xF1, 0xF3, 0xF4, 0xF8, 0xEE, 0xEF, 0x20, 0xFF, 0xE6, 0xFC,
    0xE7, 0xE9, 0xE8, 0xEB, 0x81, 0x9C, 0xEA, 0x97, 0x82, 0xEC, 0x83, 0x84,
    0x90, 0x85, 0x93, 0x86, 0x87, 0x88, 0x89, 0x96, 0x8A, 0x8B, 0x95, 0xE3,
    0xED, 0x8C, 0x8D, 0x8E, 0xDE, 0xFE, 0xE1, 0x8F, 0xE5, 0x94, 0xE2, 0xE4,
...
unsigned char qspKOI8ROrderTable[] = {
    ...
    };
...
static char *qspQSPToGameString(const QSP_CHAR*, QSP_BOOL, QSP_BOOL);
...
int qspStrCmpSB(char *s1, char *s2, unsigned char *table) {
  int ret = 0;
  while (
      !(ret = (int)table[*(unsigned char *)s1] - table[*(unsigned char *)s2]) &&
      *s2)
    ++s1, ++s2;
  return ret;
}
...
static char *qspQSPToGameString(const QSP_CHAR *s, QSP_BOOL isUCS2, QSP_BOOL isCode) {
...
int qspSplitGameStr(char *str, QSP_BOOL isUCS2, const QSP_CHAR *delim, char ***res) {
  ...
  while (found) {
    ...
    found =
        (isUCS2 ? qspUCS2StrStr(curPos, delimStr) : strstr(curPos, delimStr));
  }
  free(delimStr);
  allocChars = (isUCS2 ? (qspUCS2StrLen(curPos) + 1) * charSize
                       : (int)strlen(curPos) + 1);
...
int qspCodeWriteVal(QSP_CHAR **s, int len, const QSP_CHAR *val, QSP_BOOL isCode) {
  QSP_CHAR *temp;
  if (val) {
    if (isCode) {
