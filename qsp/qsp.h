...
enum { QSP_WIN_ACTS, QSP_WIN_OBJS, QSP_WIN_VARS, QSP_WIN_INPUT };
...
enum {
  ...
  QSP_CALL_ADDMENUITEM,     /* void func(const QSP_CHAR *name, const QSP_CHAR
                               *imgPath) */
  ...
  QSP_CALL_INPUTBOX, /* void func(const QSP_CHAR *text, QSP_CHAR *buffer, int
                        maxLen) */
  QSP_CALL_DUMMY
};
