...
void QSPCallback::QSPCallback() {
  ...
  QSPSetCallBack(QSP_CALL_PLAYFILE, (QSP_CALLBACK)&QSPCallback::playFile);
  QSPSetCallBack(QSP_CALL_CLOSEFILE, (QSP_CALLBACK)&QSPCallback::closeFile);
  QSPSetCallBack(QSP_CALL_SHOWIMAGE, (QSP_CALLBACK)&QSPCallback::showImage);
  QSPSetCallBack(QSP_CALL_SHOWWINDOW, (QSP_CALLBACK)&QSPCallback::showWindow);
  QSPSetCallBack(QSP_CALL_DELETEMENU, (QSP_CALLBACK)&QSPCallback::deleteMenu);
  QSPSetCallBack(QSP_CALL_ADDMENUITEM, (QSP_CALLBACK)&QSPCallback::addMenuItem);
  QSPSetCallBack(QSP_CALL_SHOWMENU, (QSP_CALLBACK)&QSPCallback::showMenu);
  QSPSetCallBack(QSP_CALL_SHOWMSGSTR, (QSP_CALLBACK)&QSPCallback::showMessage);
  QSPSetCallBack(QSP_CALL_REFRESHINT, (QSP_CALLBACK)&QSPCallback::refreshInt);
  QSPSetCallBack(QSP_CALL_SETTIMER, (QSP_CALLBACK)&QSPCallback::setTimer);
  QSPSetCallBack(QSP_CALL_SETINPUTSTRTEXT,
                 (QSP_CALLBACK)&QSPCallback::setInputStrText);
  QSPSetCallBack(QSP_CALL_SYSTEM, (QSP_CALLBACK)&QSPCallback::system);
  QSPSetCallBack(QSP_CALL_OPENGAMESTATUS,
                 (QSP_CALLBACK)&QSPCallback::openGameStatus);
  QSPSetCallBack(QSP_CALL_SAVEGAMESTATUS,
                 (QSP_CALLBACK)&QSPCallback::saveGameStatus);
  QSPSetCallBack(QSP_CALL_SLEEP, (QSP_CALLBACK)&QSPCallback::sleep);
  QSPSetCallBack(QSP_CALL_GETMSCOUNT, (QSP_CALLBACK)&QSPCallback::getMsCount);
  QSPSetCallBack(QSP_CALL_INPUTBOX, (QSP_CALLBACK)&QSPCallback::callInputBox);
  QSPSetCallBack(QSP_CALL_DUMMY, (QSP_CALLBACK)&QSPCallback::dummy);
}
...
void QSPCallback::callInputBox(const QSP_CHAR *text, QSP_CHAR *buffer,
                               int maxLen) {
  qDebug() << "callInputBox()"
           ...
           << ", maxLen: " << maxLen;
  QString input;
  input = QInputDialog::getText(qspWin, "", QString::fromWCharArray(text));
  input.truncate(maxLen);
  wcscpy(buffer, input.toStdWString().c_str());
}

void QSPCallback::dummy() { qDebug() << "dummy()"; }
